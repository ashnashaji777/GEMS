...
// Open popup example
// Call openPopup() when you need to show the popup.
...
// Clone carousel items to create an infinite loop
const cloneItems = carousel.innerHTML;
carousel.innerHTML += cloneItems;
